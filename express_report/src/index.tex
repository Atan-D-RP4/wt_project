...
\includegraphics[width=0.8\textwidth, height=0.7\textheight, angle=90]{express_assets/dataflow.png}
...
\include{python_code_listings.tex}

\section{Data Flow Diagram}

\includegraphics[width=0.8\textwidth, height=0.7\textheight, angle=90]{flask_assets/dataflow.png}

\subsection{Outputs}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{flask_assets/dashboard.png}
    \caption{Dashboard Interface}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{flask_assets/register.png}
    \caption{User Sign Up Interface}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{flask_assets/login.png}
    \caption{User Account Login Interface}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{flask_assets/transfers.png}
    \caption{Transaction Interface}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{flask_assets/error.png}
    \caption{Error Messages}
\end{figure}
