...
\begin{enumerate}
    ...
    \item \raggedright \url{https://www.postgresql.org/docs/}
\end{enumerate}

    Flask Documentation: \textit{https://flask.palletsprojects.com/en/2.0.x/}
    Python Documentation: \textit{https://www.python.org/doc/}
    Jinja2 Documentation: \textit{https://jinja.palletsprojects.com/en/3.0.x/}
    SQLAlchemy Documentation: \textit{https://docs.sqlalchemy.org/en/14/}
    Pipenv Documentation: \textit{https://docs.pipenv.org/}
    Full Stack Python: \textit{https://www.fullstackpython.com/flask.html}
    Real Python Flask Tutorials: \textit{https://realpython.com/tutorials/flask/}
    SQLAlchemy Official Site: \textit{https://www.sqlalchemy.org/}
\end{thebibliography}
\end{enumerate}
